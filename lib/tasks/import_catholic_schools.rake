desc "Import catholic schools data."
task :import_catholic_schools => :environment do

  File.open("../raw_data/Edmonton_Catholic_Schools__2013_-_2014_.csv", "r").each do |line|
